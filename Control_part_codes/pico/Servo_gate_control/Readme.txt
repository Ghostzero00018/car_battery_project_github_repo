...
The reason I use 5V power source is that if you use the 3.3V voltage that the Raspberry board provided, usually it is not enough to power up even the mini servo motor you can find on the market.
